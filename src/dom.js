...
const locationList = document.querySelector('#location-options');
...
const homePage = () => {
        ...
        const f = createElement('form');
                ...
                const autocompleteOptions = createElement('ul', ['home-el'], 'location-options');
        ...
        const locationButton = createElement('button', ['home-el', 'btn'], 'geolocation');
                ...
                f.append(lab, inp);
                inpDiv.append(f, locationButton, autocompleteOptions);
